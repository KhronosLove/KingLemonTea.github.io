  ...
  _createClass(Util, [
    ...
    },
    {
      ...
      value: function getScrollTop() {
        ...
        return (
          (_document$documentEle = document.documentElement) !== null && _document$documentEle !== void 0
  ...
  _createClass(FixIt, [
        ...
        this.util.forEach(document.getElementsByClassName('theme-switch'), function ($themeSwitch) {
          $themeSwitch.addEventListener(
            ...
            function () {
              ...
              ;(_window$localStorage = window.localStorage) === null || _window$localStorage === void 0
                ? void 0
                : _window$localStorage.setItem('theme', _this5.isDark ? 'dark' : 'light')
                    ...
                    _this6._index.search(query).forEach(function (_ref) {
                      ...
                      Object.keys(metadata).forEach(function (key) {
                        title = title.replace(
                          ...
                          '<'.concat(highlightTag, '>$1</').concat(highlightTag, '>')
                        )
                      ...
                      results[uri] = { uri: uri, title: title, date: matchData.date, context: context }
                    })
                  ...
                  _this6._algoliaIndex
                    ...
                    .then(function (_ref3) {
                      ...
                      hits.forEach(function (_ref4) {
                        ...
                        results[uri] = { uri: uri, title: title.value, date: date, context: content.value }
                      })
              ...
              templates: {
                ...
                empty: function empty(_ref6) {
                  ...
                  return '<div class="search-empty">'
                    .concat(searchConfig.noResultsFound, ': <span class="search-query">"')
                ...
                footer: function footer(_ref7) {
                  ...
                  return '<div class="search-footer">Search by <a href="'
                    .concat(href, '" rel="noopener noreferrer" target="_blank">')
                    .concat(icon, ' ')
    ...
    },
    {
      ...
      value: function initTocListener() {
        ...
        var $toc = document.getElementById('toc-auto')
        var $tocContentAuto = document.getElementById('toc-content-auto')
        ;(_document$querySelect = document.querySelector('#toc-auto>.toc-title')) === null ||
        ...
        this._mermaidOnSwitchTheme =
          ...
          function () {
            ...
            if ($mermaidElements.length) {
              ...
              var themes =
                (_this11$config$mermai = _this11.config.mermaid.themes) !== null && _this11$config$mermai !== void 0
        ...
        this._echartsOnSwitchTheme =
          ...
          function () {
            ...
            _this12.util.forEach(document.getElementsByClassName('echarts'), function ($echarts) {
              var chart = echarts.init($echarts, _this12.isDark ? 'dark' : 'light', { renderer: 'svg' })
        ...
        if (this.config.comment.artalk) {
          ...
          artalk.on('comments-loaded', function () {
            _this15.config.comment.artalk.lightgallery &&
              _this15.initCommentLightGallery('.atk-comment .atk-content', 'img:not([atk-emoticon])')
          })
          return artalk
        }
        ...
        if (this.config.comment.utterances) {
          ...
          this._utterancesOnSwitchTheme =
            ...
            function () {
              ...
              ;(_document$querySelect2 = document.querySelector('.utterances-frame')) === null ||
              _document$querySelect2 === void 0
                ? void 0
                : _document$querySelect2.contentWindow.postMessage(message, 'https://utteranc.es')
            }
        ...
        if (this.config.comment.giscus) {
          ...
          this._giscusOnSwitchTheme =
            ...
            function () {
              ...
              var message = { setConfig: { theme: _this15.isDark ? giscusConfig.darkTheme : giscusConfig.lightTheme } }
              ;(_document$querySelect3 = document.querySelector('.giscus-frame')) === null ||
              _document$querySelect3 === void 0
                ? void 0
                : _document$querySelect3.contentWindow.postMessage({ giscus: message }, 'https://giscus.app')
            }
    ...
    },
    {
      ...
      value: function initWatermark() {
        ...
        ;((_this$config$watermar = this.config.watermark) === null || _this$config$watermar === void 0
          ? void 0
            ...
            content:
              ...
              ''.concat(
                (_document$querySelect4 =
                  (_document$querySelect5 = document.querySelector('footer .fixit-icon')) === null ||
                  _document$querySelect5 === void 0
                    ? void 0
                    : _document$querySelect5.outerHTML) !== null && _document$querySelect4 !== void 0
                  ? _document$querySelect4
                  : '',
                ' FixIt Theme'
              ),
    ...
    },
    {
      ...
      value: function initFixItDecryptor() {
        ...
        ;((_this$config$encrypti2 = this.config.encryption) === null || _this$config$encrypti2 === void 0
          ? void 0
    ...
    },
    {
      ...
      value: function initMDevtools() {
        ...
        if (type === 'vConsole') {
          var vConsole = new VConsole({ target: '.widgets', theme: this.isDark ? 'dark' : 'light' })
    ...
    },
    {
      ...
      value: function initAutoMark() {
        ...
        window.addEventListener('beforeunload', function () {
          ...
          ;(_window$localStorage2 = window.localStorage) === null || _window$localStorage2 === void 0
            ? void 0
            : _window$localStorage2.setItem('fixit-bookmark/#'.concat(location.pathname), _this19.util.getScrollTop())
        })
        var scrollTop = Number(
          (_window$localStorage3 = window.localStorage) === null || _window$localStorage3 === void 0
            ? void 0
            : _window$localStorage3.getItem('fixit-bookmark/#'.concat(location.pathname))
        )
        ...
        window.addEventListener(
          ...
          function (event) {
            ...
            if ($fixedButtons) {
              ...
              if ($backToTop) {
                $backToTop.querySelector('span').innerText = ''.concat(Math.round(scrollPercent), '%')
              }
            }
